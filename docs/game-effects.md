...
Этот документ описывает, как в проекте устроены PvP-эффекты игры: где лежит
...
`activeEffects` и выполняет базовые игровые действия: движение, вращение, tick,
...
| `invisible_cells` | Визуально скрывает часть поставленных клеток | Board-визуал потери сигнала: горизонтальные TV-помехи, apply-импульс и apply-звук |
