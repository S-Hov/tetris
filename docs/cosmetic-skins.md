...
Этот документ описывает целевую систему скинов для PVP Blocks: что в проекте
...
Скин в PVP Blocks - это косметический предмет, который меняет внешний вид
...
Текущий игровой UI хорошо подходит для такой системы: клетки уже имеют
