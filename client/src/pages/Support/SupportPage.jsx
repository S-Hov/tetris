                    ...
                    <GlowEffect>
                        <div className="glow-effect support-form-content">
                            <div className="support-form-copy">
                                ...
                                <div className="support-channel-explainer">
                                    <p>
                                        Telegram подходит для быстрых диалогов: после отправки формы откроется бот, а история переписки сохранится в личном кабинете.
                                    </p>
                                    <p>
                                        Email удобен для ответа на почту, но в кабинете будет виден только первый текст обращения без полной истории писем.
                                    </p>
                                </div>
                            </div>
